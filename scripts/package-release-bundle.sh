...
cp scripts/migrate-legacy-install.sh "$package_dir/migrate-legacy-install.sh"
...
chmod +x "$package_dir/install.sh" "$package_dir/install-openrc.sh" "$package_dir/migrate-legacy-install.sh" "$package_dir/upgrade.sh" "$package_dir/${BIN_NAME}"
