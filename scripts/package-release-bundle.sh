...
cp scripts/migrate_config.py "$package_dir/migrate_config.py"
...
chmod +x "$package_dir/install.sh" "$package_dir/install-openrc.sh" "$package_dir/migrate_config.py" "$package_dir/upgrade.sh" "$package_dir/${BIN_NAME}"
